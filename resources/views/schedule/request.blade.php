                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="mb-4">
                                            <label class="mb-2" for="description">No Telepon :</label>
                                            <div class="input-group">
                                                <span class="input-group-text">
                                                    <i class="bi bi-chat-square-text"></i>
                                                </span>
                                                <textarea rows="3" name="description" id="description" type="input"
                                                    class="form-control
                                            @error('description') is-invalid @enderror"
                                                    placeholder="Description" aria-label="description">{{ old('test') }}</textarea>
                                            </div>
                                            @error('description')
                                                <span class="text-danger position-absolute d-block">
                                                    <small>
                                        ...
                                        <div class="mb-4">
                                            <label class="mb-2" for="description">Penanggung Jawab :</label>
                                            <div class="input-group">
                                                <span class="input-group-text">
                                                    <i class="bi bi-chat-square-text"></i>
                                                </span>
